...
def LLM_Generated_text(user_message, timeout=None):
    api_url = "http://172.27.33.101:8023/v1/chat/completions"
    model_path = "/mnt/data102_d2/huggingface/models/Meta-Llama-3___1-8B-Instruct/"
    temperature = 0.2
...
if __name__ == "__main__":
    ...
    input_file_path = f"/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/MOE/test2.json"
    output_file_path = f"/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/MOE/test3.json"
