...
if __name__ == "__main__":
    ...
    input_file_path = "/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/MOE/test0.json"
    output_file_path = "/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/MOE/test1.json"
