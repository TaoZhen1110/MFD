...
# 使用时调用的代码
input_files = [
    '/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/test2.json',  # 替换为你的输入文件路径
    '/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/train2.json',  # 替换为你的输入文件路径
    '/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/val2.json'  # 替换为你的输入文件路径
]


output_files = [
    '/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/test.json',  # 替换为你的输入文件路径
    '/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/train.json',  # 替换为你的输入文件路径
    '/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/val.json'  # 替换为你的输入文件路径
]
