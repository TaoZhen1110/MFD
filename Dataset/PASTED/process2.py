...
if __name__ == "__main__":
    ...
    input_file_path = "/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/test1.json"
    output_file_path = "/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Llama3.1/test2.json"
