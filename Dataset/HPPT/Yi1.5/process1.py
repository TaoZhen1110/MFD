...
def LLM_Generated_text(user_message, timeout=None):
    api_url = "http://172.27.33.102:8027/v1/chat/completions"
    model_path = "/mnt/data102_d2/huggingface/models/Yi-1___5-9B-Chat/"
    temperature = 0.2
...
if __name__ == "__main__":
    ...
    for file_path in file_list:
        ...
        output_file_path = f"/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/HPPT/Yi1.5/{file_path}"
