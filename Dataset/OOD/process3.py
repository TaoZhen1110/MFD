...
def LLM_Generated_text(user_message, timeout=None):
    api_url = "http://172.27.33.102:8023/v1/chat/completions"
...
if __name__ == "__main__":
    ...
    input_file_path = f"/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/OOD/test2.json"
    output_file_path = f"/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/OOD/test3.json"
