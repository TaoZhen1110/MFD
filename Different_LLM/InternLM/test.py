...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/AI_Thesis_Detection/Different_LLM/InternLM/Internlm_t5_save/run_0/internlm_t5.pth')
    parser.add_argument('-test_dataset_path', type=str,
                        default="/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Internlm2.5/test.json")
