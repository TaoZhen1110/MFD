...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/AI_Thesis_Detection/Different_LLM/Yi/Yi_t5_save/run_0/yi_t5.pth')
    parser.add_argument('-test_dataset_path', type=str,
                        default="/mnt/data132/taozhen/AI_Thesis_Detection/Dataset/PASTED/Yi1.5/test.json")
