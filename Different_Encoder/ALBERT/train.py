...
def get_argument():
    ...
    parser.add_argument('-ALBERT_Path', type=str,
                        default="/mnt/data132/taozhen/AI_Thesis_Detection/Framework/Contrastive_Model/Different_Encoder/ALBERT/albert_pretrained/")
    parser.add_argument('-Thesis_ALBERT_Encoder_Path', type=str,
                        default="/mnt/data132/taozhen/AI_Thesis_Detection/Framework/Contrastive_Model/Different_Encoder/ALBERT/albert_save/run_0/contra_albert_model.pth")
...
def main(args):
    ...
    ###################  Dataset prepare #################
    tokenizer = AlbertTokenizer.from_pretrained(args.ALBERT_Path)
    ...
    ########################  Model ###########################
    model = Multi_Level_Framework(args.ALBERT_Path, args.Thesis_ALBERT_Encoder_Path)
    ...
    for epoch in tqdm(range(args.resume_epoch, args.epochs)):
        ...
        if Mean_mse < best_f:  # 如果当前MSE小于之前的最佳值
            save_path = os.path.join(save_dir, 'albert_model' + '.pth')
